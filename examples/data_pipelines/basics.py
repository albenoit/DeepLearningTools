...
def my_preprocessing_basic_singletask(single_sample_data, single_sample_label):
  ...
  return (data, label)
dataset=dataset.map(my_preprocessing_basic_singletask)
...
#design model
def build_model_basic_singletask():
    # classical design, each input feature is a column in a (large) matrix
...
model=build_model_basic_singletask()
model.summary()
