...
apptainer run --nv /path/to/tf2_addons.sif -m deeplearningtools.experiments_manager --usersettings=examples/embedding/mysettings_1D_experiments.py
---> this will create an experiment folder with all model checkpoints and training parameters history, say: /path/to/experiments/examples/embedding/TS_trials_depth3_nstacks1_nlayers2_nneurons32_smoothedParamsTrue_nbEpoch2_bottleneckSize2_learningRate0.0005_tsLengthIn128_tsLengthOut10_nbChannels11_batchSize10_2022-12-05--18:01:39
...
model_file='examples/embedding/model_ts_AE.py'
